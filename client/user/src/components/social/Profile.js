            ...
            <div className="card vh-container" id="social-profile-inside">
                ...
                <div className="d-flex flex-row justify-content-between align-items-baseline status-info">
                    ...
                    <div className="dropdown current-status-dropdown">
                        <button className="btn text-info d-flex flex-row-reverse align-items-center"
                                ...
                                aria-expanded="false" type="button">Select your status
                        </button>
                        <div className="dropdown-menu"><a className="dropdown-item" href="#">Do not
                            disturb</a><a className="dropdown-item"
                                          href="#">Invisible</a><a
                ...
                <div className="d-flex flex-row justify-content-between align-items-baseline status-info">
                    ...
                    <div className="dropdown current-status-dropdown">
                        <button className="btn text-info d-flex flex-row-reverse align-items-center"
                                data-toggle="dropdown"
                                aria-expanded="false" type="button">Select your mood
                        </button>
                        <div className="dropdown-menu"><a className="dropdown-item" href="#">Prefer to stay
                            alone</a><a
                            className="dropdown-item" href="#">Feeling sociable</a><a className="dropdown-item"
                                                                                      href="#">Willing to help
                            others</a></div>
                    </div>
                </div>
                <div className="d-flex flex-row justify-content-between align-items-baseline status-info">
                    <p className="profile-status">Stories</p><textarea
                    placeholder="Tell to others what you are working on"></textarea></div>
                <div className="card-body">
                    ...
                    <a
                        className="btn text-info border rounded-0" role="button"
                        href="#" data-toggle="modal" data-target="#edit-profile-modal">Edit profile</a></div>
            </div>
                    ...
                    <div className="modal-content">
                        <div className="modal-body" id="edit-profile-container"><small>* = required
                            ...
                            <form className="form">
                                ...
                                <div className="form-group">
                                    <input className="profile-inputs" type="file"
                                           onChange="handleFiles(files,preview);" name="userfile"
                                           id="photo"
                                           size="20"/>
                                    <small className="form-text">Select a photo from your local files</small>
                                    <input className="profile-inputs" type="text" name="webPhoto" id="photo2"
                                           size="20"
